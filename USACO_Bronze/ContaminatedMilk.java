/*
PROBLEM: Contaminated Milk (USACO December 2015 Bronze #3)
LINK: http://www.usaco.org/index.php?page=viewproblem2&cpid=569

Loop through each milk to find if its possibly bad or not. To achieve this, we loop through each sick person and see if they drank that particular milk before getting
sick. If they did, that means the milk is potentially bad, so we have to count the total number of people who drank the milk regardless of whether or not they 
became sick during the party. The max number of people who got sick for a certain milk is the amount of medicine FJ has to buy.
*/
